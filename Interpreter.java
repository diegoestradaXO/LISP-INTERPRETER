...
public class Interpreter {
	...
	/**
	 * Constructor de las definiciones de los predicados
	 */
	...
	/**
	 * Definicion de las operaciones implementadas en Lisp
	 */
	...
	/**
	 * @param expresionAParsear expresion que se desea parsear
	 * @param estaDefiniendoUnaLista definicion de la lista declarada
	 * @param esClausula
	 * @return dependiendo de cada una de las condiciones
	 */
	...
	/**
	 * @param posibleOperacion posible operacion a implementar
	 * @return la operacion operacion implementada
	 */
	...
	/**
	 * @param expresion expresion utilizada
	 * @return la expresion
	 */
	...
	/**
	 * @param listaAEvaluar parametro tipo lista a evaluar
	 * @return retorna el atomo de tipo lista
	 */
	...
	/**
	 * @param listaAEvaluar recibe de parametro la lista a evaluar
	...
	/**
	 * @param operacion operacion de tipo String
	 * @return retorna si la operacion existe en los tipo de predicados
	 */
	...
	/**
	 * @param listaAEvaluar parametro de tipo lista, para evaluarla
	 * @return atomo de respuesta
	 */
	...
	/**
	 * @param listaAEvaluar lista a evaluar
	 * @return atomo
	 */
	...
	/**
	 * @param listaAEvaluar lista a evaluar tipo Lista
	...
	/**
	 * @param mapaDeParametrosYValores mapa de los parametros y valores
	 * @param atomoEnDondeMapear atomos en donde mapear
	 * @return retorna el atomo de la lista a evaluar
	 */
	...
	/**
	 * @param listaAEvaluar lista a evaluar de tipo lista
	 * @return nuevo atomo a nombre de la funcion
	 */
	...
	/**
	 * @param nombreDeLaFuncion parametro del nombre de la funcion
	 * @return retorna true o false si la funcion es valida
	 */
	...
	/**
	 * @param listaAEvaluar recibe el parametro de tipo lista
	 * @return la division
	 */
	...
	/**
	 * @param listaAEvaluar recibe la lista a evaluar de tipo
	...
	/**
	 * @param listaAEvaluar lista a evaluar de tipo Lista
	 * @return retorna la suma ya realizada
	 */
	...
	/**
	 * @param listaAEvaluar lista a evaluar de tipo Lista
	 * @return la multiplicacion ya realizada
	 */
	...
	/**
	 * @param listaAEvaluar lista a evaluar de tipo Lista
	 * @return retorna el primer atomo
	 */
